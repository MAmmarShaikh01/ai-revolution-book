...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    {
      type: 'category',
      label: 'ماڈیول 1: روبوٹکس کے لیے فزیکل اے آئی کی بنیادیں',
      items: [
    ...
    {
      type: 'category',
      label: 'ماڈیول 2: ہیومنوائڈ روبوٹ کے لیے کنٹرول سسٹم',
      items: [
    ...
    {
      type: 'category',
      label: 'ماڈیول 3: ہیومنوائڈ کے لیے ادراک اور سینسنگ',
      items: [
    ...
    {
      type: 'category',
      label: 'ماڈیول 4: انسان-روبوٹ کی بات چیت اور خودمختاری',
      items: [
