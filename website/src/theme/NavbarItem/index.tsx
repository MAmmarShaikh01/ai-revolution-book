...
export default function NavbarItemWrapper(props: Props): JSX.Element {
  ...
  const handleLogout = () => {
    ...
    if (location.pathname.includes('/docs-software/') || location.pathname.includes('/docs-hardware/')) {
      history.push('/physical-ai-humanoid-robotics-book/');
    }
  };
  ...
  const handleAuthSuccess = (userData: any, token: string) => {
    ...
    if (backgroundType) {
      ...
      if (location.pathname.startsWith('/physical-ai-humanoid-robotics-book/docs/')) {
        const pagePath = location.pathname.replace('/physical-ai-humanoid-robotics-book/docs/', '');
        const newPath = `/physical-ai-humanoid-robotics-book/docs-${backgroundType}/${pagePath}`;
        ...
        history.push(`/physical-ai-humanoid-robotics-book/docs-${backgroundType}/intro`);
      }
    }
  };
