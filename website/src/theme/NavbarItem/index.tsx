  ...
  const handleAuthSuccess = (userData: any, token: string) => {
    ...
    if (backgroundType) {
      ...
      if (location.pathname.includes('/docs/')) {
        const pagePath = location.pathname.replace('/docs/', '').replace('/docs-software/', '').replace('/docs-hardware/', '').replace('/docs-urdu/', '');
        const newPath = `/docs-${backgroundType}/${pagePath}`;
        ...
        history.push(`/docs-${backgroundType}/intro`);
      }
    }
  };
