...
const BACKEND_URL = process.env.NODE_ENV === 'development'
  ? 'http://localhost:8000'
  : 'https://backend-ai-production-c2ee.up.railway.app';
...
export default function RAGChatbot(): React.ReactElement {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: 'Hi! I\'m your AI Physical AI & Humanoid Robotics assistant. Ask me anything about Physical AI, Control Systems, Perception, Human-Robot Interaction, or any content from the book! You can also select text on the page and ask me questions about it.'
    }
  ]);
