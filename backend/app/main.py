...
allowed_origins = [
    ...
    "https://physical-ai-humanoid-robotics-book.vercel.app",  # Vercel production
]
...
Translate the following technical content about Physical AI and Humanoid Robotics to {request.target_language}.
